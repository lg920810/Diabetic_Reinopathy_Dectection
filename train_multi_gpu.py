...
def train_and_val(args):
    ...
    val_loader = torch.utils.data.DataLoader(val_ds, batch_size=args.batch_size, sampler=RandomSampler(val_ds))
    ...
    optimizer = torch.optim.SGD([
        {'params': model.avg_pool.parameters()},
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', default='densenet121_finetune_1024_1024_classes_2.ckpt30', type=str, metavar='PATH',
